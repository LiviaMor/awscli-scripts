#!/bin/bash
# Este script assume uma role temporária, lista as instâncias EC2 disponíveis e permite ao usuário escolher uma instância para iniciar.
...
# Perguntar qual instância iniciar
echo ""
read -p "Digite o ID da instância que deseja iniciar: " INSTANCE_ID
